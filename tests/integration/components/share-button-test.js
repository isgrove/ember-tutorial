...
module('Integreation | Component | share-button', function (hooks) {
  ...
  test('it suppoers passing @text', async function (assert) {
    await render(
  ...
  test('it suppoers passing @hashtags', async function (assert) {
    await render(
